...
<div class= "header sticky">
    <h1>User Information Update  [ <a href="dashboard.php">Dashboard</a> ]</h1> 
</div>
...
if ($userQuery->num_rows > 0) {
    ...
    while($row = $userQuery->fetch_assoc()) {
      ...
      $PerAddress=$row["PermanentAddress"];
      $Date=$row["DOB"];
      $Pass=$row["Password"];
      // $photo=$row["File_Path"];
 ...
 <form  action="" onsubmit="return validateForm()" method="POST" >
        ...
        <tr>
           ...
           <td> 
            ...
            <td> <input type="tel" id="phone" name="phone"  onkeyup="CheckmyPhone()" value="<?php echo $Phone;?>"></td>
            <td> 
            <h5 id="errorphone"></h5>
        </td>
            <?php  ?>
            ...
            <td>  <input type="email" id="email" name="email" onkeyup="showmyuser()" value="<?php echo $Email;?>"></td>
            <td> 
            <h5 id="erroremail"></h5>
        </td>
            <?php  ?>
        ...
        <td> <input type="text" name="username" id="userName" onkeyup="Checkmyuser()" value="<?php echo $User;?>" readonly /></td>
        <td>
        ...
        <center> <input type="submit" style="padding-top:-30px;width:13%;border-radius:5px;margin-left:78px;background-color:#ffbf80" name="update" value="Update"/> </center>
